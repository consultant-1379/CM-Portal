...
HistoryListController.$inject = ['$window', 'Authentication', '$scope', '$compile', '$stateParams', 'logs'];
export default function HistoryListController($window, Authentication, $scope, $compile, $stateParams, logs) {
  var vm = this;
