#!/bin/sh
# This script will restore from fixed backed up of CM PORTAL Users db data in folder database_data.
# Note:
...
docker exec -it $MONGO mongo cmportal --eval "db.dropDatabase()"
